...
///A struct representing a Butterworth bandpass filter implemented using the biquad algorithm.
///
...
/// #Issues
/// 
/// This filter has a known issue of scaling down the output, therefore is currently unreliable
pub struct BiquadButterworth {
    
    sample_rate: Hertz<f32>,       // The sample rate of the input data in Hz.
    high_cutoff: Hertz<f32>,       // The higher frequency cutoff of the bandpass filter in Hz.
    low_cutoff: Hertz<f32>,        // The lower frequency cutoff of the bandpass filter in Hz.
    biquad1: DirectForm1<f32>,     // The biquad filter implementation.
}

impl BiquadButterworth{

        /// Creates a new instance of the Butterworth bandpass filter.
        ///
        /// # Arguments
        ///
        /// * `low_cutoff` - The lower frequency cutoff of the bandpass filter in Hz.
        /// * `high_cutoff` - The higher frequency cutoff of the bandpass filter in Hz.
        ...
        ///
        /// ```rust
        /// use mods::digital_filters::iir:bandpass::butterworth::BiquadButterworth;
        /// use biquad::Hertz;
        ///
        ...
        /// Processes the input data using the Butterworth bandpass filter and returns the filtered data.
        ///
        /// # Arguments
        ///
        ...
        /// Applies the Butterworth bandpass filter using forward-backward filtering ("filtfilt").
        ///
        ...
        pub fn filtfilt(&mut self, input: RawData) -> Vec<f32>{
            ...
            let mut filterclone: BiquadButterworth = super::butterworth::BiquadButterworth::new(self.low_cutoff, self.high_cutoff, self.sample_rate);
